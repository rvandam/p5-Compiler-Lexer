...
use constant {
    ...
    T_PostfixArrayDereference => 122,
    T_Key => 123,
    T_BareWord => 124,
    T_Arrow => 125,
    T_Pointer => 126,
    T_NamespaceResolver => 127,
    T_Namespace => 128,
    T_Package => 129,
    T_Class => 130,
    T_CallDecl => 131,
    ...
    T_SpecificValue => 138,
    T_ConstValue => 139,
    T_ProgramArgument => 140,
    T_LibraryDirectories => 141,
    T_Environment => 142,
    T_Include => 143,
    T_Signal => 144,
    T_RegOpt => 145,
    T_RegQuote => 146,
    T_RegDoubleQuote => 147,
    T_RegList => 148,
    T_RegExec => 149,
    T_RegDecl => 150,
    T_RegMatch => 151,
    T_RegDelim => 152,
    T_HandleDelim => 153,
    T_RegMiddleDelim => 154,
    T_RegAllReplace => 155,
    T_RegReplace => 156,
    T_RegReplaceFrom => 157,
    T_RegReplaceTo => 158,
    T_FieldDecl => 159,
    T_TypeRef => 160,
    T_LabelRef => 161,
    T_LocalVarDecl => 162,
    T_GlobalVarDecl => 163,
    T_MultiLocalVarDecl => 164,
    T_MultiGlobalVarDecl => 165,
    T_Prototype => 166,
    T_Var => 167,
    T_CodeVar => 168,
    T_ArrayVar => 169,
    ...
    T_ExecString => 175,
    T_VersionString => 176,
    T_HereDocumentTag => 177,
    T_HereDocumentRawTag => 178,
    T_HereDocumentExecTag => 179,
    T_HereDocumentBareTag => 180,
    T_RawHereDocument => 181,
    T_HereDocument => 182,
    T_HereDocumentEnd => 183,
    T_FormatDecl => 184,
    T_Format => 185,
    T_FormatEnd => 186,
    T_Object => 187,
